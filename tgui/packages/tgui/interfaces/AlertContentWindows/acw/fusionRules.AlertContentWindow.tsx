...
const FusionRulesContentWindow = () => {
  return (
    <Section title="Welcome to Goonstation!">
      ...
      <Section title="2. Antagonists may attack without warning.">
        But are still expected to make some kind of story out of their actions.
        Death should contribute to or spark roleplay, be funny, or be meaningful
        in some way other than a desire to see how many frags you can get. You
        should not go on a station wiping rampage just for the sake of
        rampaging. As security, your priority is the crew’s safety and
        maintaining the peace. You should treat criminals fairly and determine
        appropriate consequences for their actions. Enemies to Nanotrasen such
        as confirmed non-human antagonists and open syndicate members may be
        treated harshly.
      </Section>
      ...
      <Section title="4. As an antagonist you are free to kill and grief.">
...
export const acw: AlertContentWindow = {
  width: 800,
  height: 600,
  title: 'Goonstation Fusion RP Server Guidelines and Rules',
  component: FusionRulesContentWindow,
};
